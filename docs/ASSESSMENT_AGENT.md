...
| **A2 — Full pipeline** | Obligation mapping, gap analysis, remediation/tradeoffs, report assembly + markdown export, clarification round, deletion endpoint, assessment rate limit | 3–4 days |
